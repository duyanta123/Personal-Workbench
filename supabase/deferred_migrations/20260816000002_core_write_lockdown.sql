-- Deploy after the V2 command client (including pomodoro/avatar migration) has
-- completed one release cycle. All client writes now go through security-definer
