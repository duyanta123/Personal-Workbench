...
-- workout_exercises.user_id 自 20260813000001 起为 NOT NULL（default auth.uid()），
-- 种子插入运行在无认证上下文的超级用户会话中，必须显式提供 user_id。
insert into public.workout_exercises (id, session_id, user_id, name) values
  ('28000000-0000-0000-0000-000000000001', '27000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'A exercise'),
  ('28000000-0000-0000-0000-000000000002', '27000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'B exercise');
...
-- user_preferences 行由 auth.users 的注册触发器自动创建，显式插入会与触发器冲突。
